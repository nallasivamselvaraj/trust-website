      ...
      <main className="flex-1">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                  True empowerment comes from within communities. Our programs focus on building capacity, 
                  developing skills, and creating opportunities that enable individuals and communities to 
                  become self-reliant and drive their own development.
                </p>
                <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                  Through skill development, women's empowerment, youth engagement, and livelihood programs, 
        ...
        <section className="py-16 bg-purple-50">
          <div className="max-w-6xl mx-auto px-6">
            <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">Empowerment Impact</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { icon: Users, number: "75,000+", label: "People Empowered", desc: "Across all programs" },
                { icon: Briefcase, number: "15,000+", label: "Jobs Created", desc: "Sustainable livelihoods" },
                { icon: GraduationCap, number: "25,000+", label: "Skills Trained", desc: "Vocational programs" },
                { icon: TrendingUp, number: "80%", label: "Income Increase", desc: "Average improvement" }
              ].map((stat, idx) => (
        ...
        <section className="py-16 px-6">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">Our Empowerment Programs</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                {
                  title: "Women's Empowerment",
                  description: "Comprehensive programs focusing on women's economic independence, leadership development, and social empowerment.",
                  features: ["Self-help groups", "Microfinance access", "Leadership training", "Rights awareness"]
                },
                {
                  title: "Youth Skill Development",
                  description: "Vocational training and skill development programs for youth to enhance employability and entrepreneurship.",
                  features: ["Technical skills", "Soft skills training", "Job placement", "Entrepreneurship support"]
                },
                {
                  title: "Rural Entrepreneurship",
                  description: "Supporting rural entrepreneurs through business development, market linkages, and financial assistance.",
                  features: ["Business planning", "Market access", "Financial support", "Mentorship programs"]
                },
                {
                  title: "Digital Literacy",
                  description: "Bridging the digital divide through technology training and digital financial inclusion programs.",
                  features: ["Computer training", "Internet skills", "Digital payments", "Online business"]
                },
                {
                  title: "Livelihood Programs",
                  description: "Creating sustainable livelihood opportunities through agriculture, handicrafts, and small-scale industries.",
                  features: ["Agricultural training", "Handicraft development", "Market linkages", "Quality improvement"]
                },
                {
                  title: "Community Leadership",
                  description: "Building local leadership capacity and strengthening community institutions for self-governance.",
                  features: ["Leadership training", "Governance skills", "Community planning", "Advocacy training"]
                }
              ].map((program, idx) => (
                <Card key={idx} className="p-6 hover:shadow-lg transition-shadow border-l-4 border-l-purple-600">
                  <CardContent className="p-0">
        ...
        <section className="py-16 bg-gradient-to-r from-purple-600 to-pink-600">
          <div className="max-w-4xl mx-auto text-center px-6 text-white">
            <h2 className="text-3xl font-bold mb-4">Empower Communities, Transform Lives</h2>
