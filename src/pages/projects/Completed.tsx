  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="py-12 max-w-6xl mx-auto px-4">
        <h1 className="text-3xl font-bold mb-4">Completed Projects</h1>
        <p className="text-muted-foreground mb-8">A selection of our completed works and case studies.</p>
